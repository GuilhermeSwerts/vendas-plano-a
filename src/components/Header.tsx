    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
            <nav className="max-w-7xl mx-auto flex items-center justify-between glass px-6 py-3 rounded-full border-white/5">
                ...
                <a href="https://kompleto.app.br/Account/LoginClientes" target="_blank "  className="bg-cta-primary hover:bg-cta-hover text-background-dark px-6 py-2 rounded-full text-sm font-black transition-all shadow-lg hover:shadow-cta-primary/20 hover:scale-105 active:scale-95 uppercase tracking-tighter">
                    Entrar
                </a>
            </nav>
        </header>
