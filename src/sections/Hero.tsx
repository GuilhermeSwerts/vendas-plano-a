    ...
    return (
        <section id="hero" className="relative min-h-[95vh] flex items-center justify-center pt-24 overflow-hidden bg-radial-[at_center_center] from-background-gradient to-background-dark">
            ...
            <div className="max-w-6xl mx-auto px-6 text-center space-y-10 relative z-10">
                ...
                <h1 className="text-5xl md:text-8xl font-black tracking-tight leading-[1] uppercase italic text-white">
                    ENQUANTO OUTROS SÓ APOSTAM, <b>VOCÊ CONCORRE</b>
                    <br />
                ...
                <div className="space-y-4 max-w-3xl mx-auto">
                    ...
                    <p className="text-md md:text-xl text-text-muted leading-relaxed">
                        Por apenas <span className="text-accent font-bold">R$ 1,50/mês</span>, participe de sorteios mensais e tenha acesso a descontos em lojas, serviços, lazer, bem estar, saúde e alimentação.
                    </p>
                </div>
