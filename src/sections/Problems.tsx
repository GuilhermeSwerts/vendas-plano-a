                ...
                <div className="glass p-10 rounded-3xl space-y-8 text-left border-accent/20">
                    <ul className="space-y-6">
                        <li className="flex gap-4">
                            ...
                            <p className="text-2xl font-bold text-white">O problema não é um gasto grande.</p>
                        </li>
                        <li className="flex gap-4">
                            <span className="text-3xl">👉</span>
                            <p className="text-2xl font-bold text-white">É a soma dos pequenos gastos do dia a dia.</p>
                        </li>
                    </ul>
                    <div className="pt-6">
